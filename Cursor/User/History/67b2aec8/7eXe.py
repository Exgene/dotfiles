...
def run_master():
    ...
    # World size is the number of workers plus 1 (for the master)
    # Rank is a unique identifier for each workers
    ...
    print("worker1", future1.wait())
    print("worker2", future2.wait())
