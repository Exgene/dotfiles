...
This Python library allows interaction with WhatsApp using Playwright.

# Core Functions

The library provides a set of core functions to interact with WhatsApp. All the APIs provided are asynchronous in nature.
