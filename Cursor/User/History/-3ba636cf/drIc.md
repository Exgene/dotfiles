...
To make the implementation easier, we can separate message retrieval and message sending into two browsers... this will probably make things easier in the short term (later we can consolidate)
