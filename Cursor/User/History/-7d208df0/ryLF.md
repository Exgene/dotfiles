...
future. 
    1. You have these large foundational AGI models that run in some centralized server by companies such as OpenAI etc.
        AI keeps evolving while humans don't physically evolve. If we go with this path the gap between humans and AI will keep increasing.
    2. You augment yourself to evolve along with the highly intelligent models.
