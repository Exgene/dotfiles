  ...
  .aggregate([
    {
      $lookup: {
        ...
        localField: "empId", // Field from the employees collection
    ...
    {
      $unwind: {
        path: "$departmentDetails", // Unwind the array to flatten the results
        preserveNullAndEmptyArrays: true, // Keep employees without departments
      },
    },
    {
      $project: {
        name: 1, // Include employee name
        age: 1, // Include employee age
        "departmentDetails.depId": 1, // Include department ID
        "departmentDetails.departName": 1, // Include department name
      },
    },
  ])
  .pretty();
